...
<p align = "center"><font face = "verdana" size = "5"><b>Doações Recebidas</b></font>	
...
<div>
	<table border = "1" cellspacing="0" cellpadding="0">
		<tr bgcolor = "#4d4d4d">
			<td><p align = "center"><font face = "verdana" color = "white" size = "2">Doador</font></td>
		...
		<c:forEach var="doacao" items="${doacoes}">
			<tr>
				<td bgcolor = "white"><p align = "center"><font face = "verdana" size = "2">${doacao.doador.nome}</font></td>
